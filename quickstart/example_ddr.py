...
# Load reference data to get list of drugs (LINCS-filtered: ships with this repo)
disease_drug_df = pd.read_csv(os.path.join(DATA_DIR, 'opentargets/disease_drug_triples_csv/disease_drug_triples_lincs.csv'))
drug_smiles_list = disease_drug_df['smiles'].unique().tolist()


# ============================ EMBEDDING BLOCK ============================
# Replace this block with your own model. 
