...
# --- Define model paths ---
CP_BETA_PATH = os.path.join(DATA_DIR, 'drug_target_networks/trt_cp_AIDOcell_targetnetworks/full_dataset_betas.npy')
CP_PRED_CSV_PATH = os.path.join(DATA_DIR, 'drug_target_networks/trt_cp_AIDOcell_targetnetworks/full_dataset_predictions.csv')
